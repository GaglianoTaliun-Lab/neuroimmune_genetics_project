...
args <-
  list(
    ...
    loc_file = here(project_dir,"test_loci","window_100000", "AD_replication_pqtls.loci"),
    info_file = here(project_dir,"info_files", "input.info.replication.AD.pqtls.txt"),
...
saveRDS(
  univar,
  file = here(project_dir,"lava_results","lava_pqtls","univ", str_c("GWAS_with_pqtls_AD_replication.univ.lava.rds"))
)
saveRDS(
  bivar,
  file = here(project_dir,"lava_results","lava_pqtls","bivar", str_c("GWAS_with_pqtls_AD_replication.bivar.lava.rds"))
)
