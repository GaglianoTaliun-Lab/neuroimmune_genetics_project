...
for(test in names(results)){
  ...
  write.table(results_wrangled, here(project_dir,"lava_results","tsv_univ_bivar_QTLs",stringr::str_c("all_results_",test,"_",window,"_",date,".tsv")),
    ...
    results_wrangled %>% 
      ...
      write.table(., here(project_dir,"lava_results","tsv_univ_bivar_QTLs",stringr::str_c("bonferroni_significant_results_",test,"_",window,"_",date,".tsv")),
                  sep = "\t", quote=F, row.names=F)
    ...
    results_wrangled %>%
      ...
      write.table(., here(project_dir,"lava_results","tsv_univ_bivar_QTLs",stringr::str_c("FDR_significant_results_",test,"_",window,"_",date,".tsv")),
                  sep = "\t", quote=F, row.names=F)
