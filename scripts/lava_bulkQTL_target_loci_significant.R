...
saveRDS(
  univar,
  file = here(project_dir,"lava_results","lava_QTLs","univ", str_c("GWAS_with_bulkQTL_significant.univ.lava.rds"))
)
saveRDS(
  bivar,
  file = here(project_dir,"lava_results","lava_QTLs","bivar", str_c("GWAS_with_bulkQTL_significant.bivar.lava.rds"))
)
