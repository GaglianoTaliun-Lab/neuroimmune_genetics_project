...
args <-
  list(
    ...
    loc_file = here(project_dir,"test_loci","window_100000", "pqtls_filtered.loci"),
    info_file = here(project_dir,"info_files", "input.info.pqtl_gwas.txt"),
...
saveRDS(
  univar,
  file = here(project_dir,"lava_results","lava_pqtls","univ", str_c("GWAS_with_pqtls_chunk_",chunk_name,".univ.lava.rds"))
)
saveRDS(
  bivar,
  file = here(project_dir,"lava_results","lava_pqtls","bivar", str_c("GWAS_with_pqtls_chunk_",chunk_name,".bivar.lava.rds"))
)
