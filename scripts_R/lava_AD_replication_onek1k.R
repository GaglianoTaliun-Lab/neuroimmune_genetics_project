# LAVA QTL FLD
# Description: run univariate and bivariate tests for eQTL/GWAS traits as a replication for AD signals
...
args <-
  list(
    ...
    loc_file = here(project_dir,"test_loci","window_100000","AD_replication_onek1k.loci"),
    info_file = here(project_dir,"info_files", "input.info.replication.AD.onek1k.txt"),
    gwas_info = here(project_dir, "info_files", "input.info.replication.AD.txt"),
    phenotypes = c(""),
...
saveRDS(
  univar,
  file = here(project_dir,"lava_results","lava_onek1k_QTLs","univ", str_c("GWAS_QTLs_",cell_type_eqtl, "_AD_replication.univ.lava.rds"))
)
saveRDS(
  bivar,
  file = here(project_dir,"lava_results","lava_onek1k_QTLs","bivar", str_c("GWAS_QTLs_",cell_type_eqtl, "_AD_replication.bivar.lava.rds"))
)
